...
def run_benchmark(target_n):
    ...
    cmd = (
        ...
        f"--length {target_n} --batchSize 1000 --precision double --transformType 0 -o -N 10"
    )
...
def tune_for_N(target_n):
    ...
    csv_output = f"tuning_results_z2z_{target_n}.csv"
...
def main():
    ...
    for target in [65536,131072,262144,524288]:
        tune_for_N(target)
